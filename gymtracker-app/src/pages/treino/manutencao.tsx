...
import { ChevronLeft, ChevronRight, Plus, Trash2, GripVertical, AlertCircle } from 'lucide-react'
...
export default function ManutencaoPage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({ title: 'Programa criado com sucesso! Bom treino! 💪' })
      navigate('/')
    },
    onError: (err: unknown) => {
  ...
  const removeBlock = (i: number) => {
    ...
    // atualizar block_configs nos splits
